...
RULES = [
    ...
    {"id": 4, "rule": "ของแถมแสดงเป็นกล่องปริศนา (mystery box) ไม่ใช่ภาพสินค้าจริง"},
...
4. ของแถมแสดงเป็นกล่องปริศนา (mystery box) — ภาพของแถมต้องไม่แสดงสินค้าจริงให้เห็นชัด ต้องเป็นกล่องปริศนาที่มีเครื่องหมาย ? หรือกล่องที่ไม่เปิดเผยสินค้าข้างใน กล่องจะเป็นสีอะไรก็ได้ (สีดำ สีแดง สีน้ำตาล ฯลฯ) ขอแค่ไม่แสดงภาพสินค้าจริงก็ถือว่าผ่าน
5. มีข้อความระบุว่าของแถมไม่ซ้ำกับสินค้าที่ซื้อ — มองหาข้อความที่มีคำว่า 'สินค้าที่แถม' และ 'ไม่เป็นรายการเดียวกัน' อยู่ในภาพ ข้อความนี้มักเป็นตัวอักษรเล็กสีเหลืองหรือสีทอง อยู่ใกล้คำว่า 'โปรโมชั่น' หรือ 'สินค้าที่แถม' ตัวอย่างข้อความที่ถือว่าผ่าน: 'สินค้าที่แถม ต้องไม่เป็นรายการเดียวกัน กับสินค้าที่ซื้อ' หรือ 'สินค้าที่แถมต้องไม่เป็นรายการเดียวกับสินค้าที่ซื้อ' ถ้าเห็นข้อความที่สื่อความหมายนี้ไม่ว่าจะตัดคำต่างกันอย่างไรก็ถือว่าผ่าน ข้อความนี้มีอยู่ในภาพแน่นอน ให้ดูให้ละเอียดทุกพิกเซล
        ...
        messages=[
            {
                ...
                "content": [
                    ...
                    {"type": "text", "text": "กรุณาตรวจสอบแอดโฆษณานี้ตามเกณฑ์ 5 ข้อ สำคัญมาก: ข้อ 4 กล่องปริศนาจะเป็นสีอะไรก็ได้ไม่จำเป็นต้องสีดำ ข้อ 5 ให้มองหาข้อความเล็กๆ สีเหลืองที่เขียนว่า สินค้าที่แถม ต้องไม่เป็นรายการเดียวกัน ใกล้บริเวณโปรโมชั่น"},
                ],
            }
        ],
    )
